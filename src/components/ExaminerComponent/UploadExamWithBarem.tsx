...
const UploadExamWithBarem: React.FC = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center gap-12">
      ...
      {/* Upload Barem */}
      <div className="bg-gradient-to-br from-green-100 via-white to-green-50 rounded-3xl shadow-2xl p-10 flex flex-col items-center space-y-5 min-w-[340px] max-w-lg w-full border border-green-200 animate-fade-in">
        <div className="flex flex-col items-center mb-2">
